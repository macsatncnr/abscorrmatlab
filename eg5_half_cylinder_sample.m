function sample = eg5_half_cylinder_sample(r,l)
...
sample.VEI=[0,r/2,0];  %VEI= define volume element inside
sample.box_bottom=-1*[r,0,l/2];  %box lower corner
sample.box_dimensions=[2*r,r,l];  %box dimensions
