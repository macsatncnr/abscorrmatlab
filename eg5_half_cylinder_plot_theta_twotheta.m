...
N_element_theta=0;
fileID_write = fopen('all_angles_half_cylinder_transmission.txt','w');
tic
for theta=thetarange(1):thetarange(3):thetarange(2)
   ...
   for twotheta=twothetarange(1):twothetarange(3):twothetarange(2)
       ...
       [transm,volume] = eg5_half_cylinder_transmission(theta,twotheta);
...
save('theta_angles_half_cyl.mat','theta_angles');
save('twotheta_angles_half_cyl.mat','twotheta_angles');
save('transmission_half_cyl.mat','transmission');
