...
N_element_theta=0;
fileID_write = fopen('all_angles_prism_transmission_mu_4.txt','w');
tic
for theta=thetarange(1):thetarange(3):thetarange(2)
   ...
   for twotheta=twothetarange(1):twothetarange(3):twothetarange(2)
       ...
       [transm,volume] = eg7_prism_transmission(theta,twotheta);
...
save('theta_angles_prism_mu_4.mat','theta_angles');
save('twotheta_angles_prism_mu_4.mat','twotheta_angles');
save('transmission_prism_mu_4.mat','transmission');
