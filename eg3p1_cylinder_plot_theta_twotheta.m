...
N_element_theta=0;
fileID_write = fopen('theta_2theta_cylinder_transmission.txt','w');
tic
for theta=thetarange(1):thetarange(3):thetarange(2)
   ...
   for twotheta=twothetarange(1):twothetarange(3):twothetarange(2)
       ...
       [transm,volume] = eg3p1_cylinder_transmission_theta_twotheta(theta,twotheta);
...
save('theta_angles_cyl.mat','theta_angles');
save('twotheta_angles_cyl.mat','twotheta_angles');
save('transmission_cyl.mat','transmission');
